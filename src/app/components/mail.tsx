...
import { setCollapsed, selectMail, setMails } from "@/store/slices/mailComponentSlice";
...
export function Mail({
  ...
  const { isCollapsed, selectedMailId } = useSelector((state: RootState) => state.mailComponent);
